...
INPUT_FILE = 'gs://YOUR-PROJECT-ID-data-bucket/from-git/chapter-6/dataset/logs_example.txt'
OUTPUT_PATH = 'gs://YOUR-PROJECT-ID-data-bucket/chapter-6/dataflow/output/output_file_'
