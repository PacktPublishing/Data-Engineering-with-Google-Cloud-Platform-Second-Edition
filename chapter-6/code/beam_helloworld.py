...
INPUT_FILE = 'gs://wired-apex-392509-data-bucket/from-git/chapter-6/dataset/logs_example.txt'
OUTPUT_PATH = 'gs://wired-apex-392509-data-bucket/chapter-6/dataflow/output/output_file_'
